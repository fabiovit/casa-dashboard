    ...
    if supplied_rooms is not None:
        ...
        for room in supplied_rooms:
            ...
            clean_rooms.append({
                ...
                "background_gradient_b": str(room.get("background_gradient_b", "#183040")).strip() or "#183040",
                "background_gradient_angle": float(room.get("background_gradient_angle", 135) or 135),
