...
[![Release](https://img.shields.io/badge/release-v3.0.0-blue)](https://github.com/fabiovit/casa-dashboard/releases)
...
La **v3.0.0** è una release di consolidamento: il progetto è stato ripulito, il versioning è ora coerente tra backend e frontend e tutte le funzioni mature introdotte nella serie 2.x restano disponibili in un pacchetto più ordinato.
