...
**Casa Dashboard Community v2.1.0** includes two visual experiences, **Casa V1** and **Casa V2**, dynamic rooms, in-dashboard entity configuration and native **English / Italian** language support.
...
Version 2.1.0 adds native **English / Italian** language support directly inside the dashboard.
