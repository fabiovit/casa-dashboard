...
**v4.4.1** fixes water-leak sensor state rendering (Dry/Wet) while preserving normal numeric humidity readings.
...
Special thanks to **Mario Pagano** for desktop and mobile testing and verification.
